                                  ...
                                  <div class="simplebar-content-wrapper" style="height: 100%; overflow: hidden scroll;">
                                      <div class="simplebar-content" style="padding: 15px 25px;">
                                          ...
                                          <li class="sidebar-list"> <i class="fa-solid fa-thumbtack">
                                                  ...
                                                  <svg class="iconly-Arrow-Right-2 icli"
                                          ...
                                          <li class="sidebar-list">
                                            <i class="fa-solid fa-thumbtack">
                                                ...
                                                <h6 class="f-w-600">Post</h6> <svg class="iconly-Arrow-Right-2 icli"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="0 0 320 512"><!--!Font Awesome Free 6.7.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                                                <path
                                                    d="M310.6 233.4c12.5 12.5 12.5 32.8 0 45.3l-192 192c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L242.7 256 73.4 86.6c-12.5-12.5-12.5-32.8 0-45.3s32.8-12.5 45.3 0l192 192z" />
                                                ...
                                                <ul class="sidebar-submenu">
                                                    <li> <a href="{{ route('add-blog') }}">Add Post</a></li>
                                                    <li> <a href="{{ route('manage-blog') }}">Manage Post</a></li>
                                                </ul>
                                        </li>
                                        ...
                                        <li class="sidebar-list"> <i class="fa-solid fa-thumbtack">
                                            ...
                                            </i><a class="sidebar-link" href="{{route('register-admin')}}">
                                            <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" id="Game"
                                            viewBox="0 0 24 24" version="1.1">
                                            <g fill="none" fill-rule="evenodd" clip-rule="evenodd"
                                            ...
                                            <h6 class="f-w-600">Add Admin</h6></a>
                                        </li>
                                        @endif
                                      </div>
                                  </div>
