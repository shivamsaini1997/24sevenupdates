                                ...
                                <table class="display" id="basic-1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{asset($item->post_thumbnail)}}" width="80px" alt="">
                                               
                                            </td>
                                            <td>
                                                 <div class="scroll-overflow">
                                                    {{$item->meta_description}}</td>
                                                </div>
                                            <td>
                                                <div class="scroll-overflow">
                                                    {{$item->meta_tags}}
                                            ...
                                            <td  style="width: 30%">
                                                @if ($item->status == '1')
                                                <a href="{{route('status-blog', ['id' => $item->id, 'status' => '0'])}}">
                                                    <span class="badge rounded-pill badge-success">Active</span>
                                                </a>
                                                @endif
                                                @if ($item->status == '0')
                                                <a href="{{route('status-blog', ['id' => $item->id, 'status' => '1'])}}">
                                            ...
                                            <td  style="width: 30%">
                                                <ul class="action">
                                                    <li class="edit">
                                                        <a href="{{route('edit-blog', ['id' => $item->id])}}">
                                                    ...
                                                    <li class="delete">
                                                        <a href="{{route('delete-blog', ['id' => $item->id])}}" class="open-detele-modal" type="button" data-bs-toggle="modal" data-bs-target="#tooltipmodal">
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center">
                    <p class="mt-2"> Are you sure want to delete this post</p>
