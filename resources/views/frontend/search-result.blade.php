                        ...
                        @foreach ($blogs as $item)
                            <div class="weekly-post-item weekly-post-four">
                                <div class="weekly-post-thumb">
                                    <a href="{{ url(strtolower($item->category) . '/' . $item->slug) }}"><img src="{{asset($item->post_thumbnail)}}" alt="{{$item->blog_title}}"></a>
                                </div>
                                <div class="weekly-post-content">
                                    <a href="{{ url(strtolower($item->category) . '/' . $item->slug) }}" class="post-tag">{{ $item->category }}</a>
                                    <h2 class="post-title"><a href="{{ url(strtolower($item->category) . '/' . $item->slug) }}">{{$item->blog_title}}</a></h2>
                    ...
                    <div class="sidebar-wrap">
                        <div class="sidebar-widget sidebar-widget-two">
                            ...
                            <div class="sidebar-categories">
                                <ul class="list-wrap">
                                    ...
                                    <li>
                                        <a href="{{url(strtolower($item->category))}}" data-background="{{asset($item->category_thumbnail)}}">
                        ...
                        <div class="sidebar-widget sidebar-widget-two">
                            ...
                            <div class="hot-post-wrap">
                                @foreach ($allblogs->take(3) as $item)
